...
VertexOut VS_OceanFromSpace(VertexIn vin)
{
	VertexOut vout;
...
VertexOut VS_OceanFromAtmo(VertexIn vin)
{
	VertexOut vout;
		  ...
		  uniform bool gReflectionEnabled) : SV_Target
{
    ...
    float4 texColor = float4(0, 0, 1, 1);
...
technique11 OceanFromSpace
{
    pass P0
    {
        SetVertexShader( CompileShader( vs_5_0, VS_OceanFromSpace() ) );
...
technique11 OceanFromAtmo
{
    pass P0
    {
        SetVertexShader( CompileShader( vs_5_0, VS_OceanFromAtmo() ) );
        SetHullShader( CompileShader( hs_5_0, HS() ) );
        SetDomainShader( CompileShader( ds_5_0, DS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_5_0, PS(1, true, false, false, false) ) );
